...
const CardWidgetsSalesStats = () => {
  ...
  return (
    <Card>
      ...
      />
      <CardContent>
        <ReactApexcharts type='radialBar' height={292} options={options} series={[75]} />
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-around' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { mr: 1.5, color: 'action.selected' } }}>
            <Icon icon='bxs:circle' fontSize={14} />
...
export default CardWidgetsSalesStats
