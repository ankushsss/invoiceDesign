    ...
    <Card>
      <TabContext value={value}>
        ...
        <TabPanel value={value} sx={{ border: 0, boxShadow: 0, p: '0 !important', backgroundColor: 'transparent' }}>
          ...
          <ReactApexcharts type='area' height={216} options={options} series={series} />
          <Box sx={{ p: 5, pt: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
...
export default CardWidgetsTabs
